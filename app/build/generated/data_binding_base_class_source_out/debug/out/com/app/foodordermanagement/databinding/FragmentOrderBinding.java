...
public final class FragmentOrderBinding implements ViewBinding {
  ...
  private FragmentOrderBinding(@NonNull LinearLayout rootView, @NonNull RecyclerView rcvOrder) {
  ...
  public static FragmentOrderBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      id = R.id.rcv_order;
      RecyclerView rcvOrder = rootView.findViewById(id);
      if (rcvOrder == null) {
        break missingId;
      }

      return new FragmentOrderBinding((LinearLayout) rootView, rcvOrder);
    }
