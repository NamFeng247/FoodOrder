...
public final class ActivityContactBinding implements ViewBinding {
  ...
  private ActivityContactBinding(@NonNull LinearLayout rootView, @NonNull RecyclerView rcvData) {
  ...
  public static ActivityContactBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new ActivityContactBinding((LinearLayout) rootView, rcvData);
    }
